...
Automated security hardening for Debian systems using Ansible. This project is designed to pass Lynis security audits with a high score (**>80**), following best practices for Linux system administration.
...
- **Managed Node:** A clean Debian server with Python3 installed
